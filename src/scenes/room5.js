...
export default class room5 extends Phaser.Scene {
    ...
    preload() {
    // Step 1, load JSON
    this.load.tilemapTiledJSON("room5","assets/empty-room5.json");
    ...
    create() {
        console.log('*** room5 scene');
        let map = this.make.tilemap({ key: "room5" });
