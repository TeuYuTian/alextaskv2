...
export default class room3 extends Phaser.Scene {
    ...
    preload() {
    // Step 1, load JSON
    this.load.tilemapTiledJSON("room3","assets/empty-room3.json");
    ...
    this.macaw = this.physics.add.sprite(550, 300, 'macaw').play('macaw');
    this.physics.add.overlap(this.player, this.macaw, this.collectAnimal, null, this );

    }

    
    update() {
    // check for forest3 exit
